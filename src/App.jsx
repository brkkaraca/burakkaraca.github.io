...
export default function App() {
  ...
  return (
    <div
      ...
      style={{ background: "linear-gradient(to bottom, #FFFFFF 0%, #F3F4F6 50%, #E5E7EB 100%)", color: "#1A2C3A" }}
    >
      {/* HEADER (sticky + glass) */}
            ...
            <div className="space-y-6">
              {POSTS.slice(0,3).map((p) => (
                <a
                  ...
                  className="block border border-[#D6E2E8] rounded-2xl p-5 transition-colors hover:text-[#2C5F6C] cursor-pointer bg-transparent backdrop-blur backdrop-saturate-150 shadow-[0_4px_14px_rgba(26,44,58,0.06)] "
                >
      ...
      {route === "hakkimda" && (
        <section className="max-w-3xl mx-auto px-6 py-12 w-full">
          ...
          <div className="border border-[#D6E2E8] rounded-2xl p-6 bg-transparent backdrop-blur backdrop-saturate-150 shadow-[0_8px_20px_rgba(26,44,58,0.08)]">
            <img src="/profile.jpg" alt="Burak Karaca" className="h-28 w-28 md:h-32 md:w-32 rounded-xl object-cover border border-[#D6E2E8] float-none sm:float-left mr-0 sm:mr-6 mb-4 sm:mb-2" />
      ...
      {/* FOOTER (glass + sayfa dibine yapışık) */}
      <footer className="mt-auto border-t border-[#D6E2E8] text-sm py-6 px-6 flex flex-col md:flex-row justify-between items-center bg-white/10 backdrop-blur-md backdrop-saturate-150">
