        ...
        <>
          <section className="flex flex-col items-center justify-center text-center py-16 px-6">
            ...
            <div className="flex gap-4 mt-8">
              ...
              <a href="https://x.com/burakkaraca" target="_blank" rel="noopener noreferrer" onClick={(e)=>{e.preventDefault(); window.open("https://x.com/burakkaraca","_blank","noopener");}} className="inline-flex items-center justify-center w-9 h-9 rounded-full transition-opacity hover:opacity-80" title="Twitter / X" style={{ color: '#1DA1F2' }}><Twitter /></a>
              <a href="https://instagram.com/burakkaraca" target="_blank" rel="noopener noreferrer" onClick={(e)=>{e.preventDefault(); window.open("https://instagram.com/burakkaraca","_blank","noopener");}} className="inline-flex items-center justify-center w-9 h-9 rounded-full transition-opacity hover:opacity-80" title="Instagram" style={{ color: '#C13584' }}><Instagram /></a>
